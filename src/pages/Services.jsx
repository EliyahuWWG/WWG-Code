  ...
  return (
    <>
      ...
      <section className="section on-bone">
        <div className="container">
          <div className="sec-head">
            <div className="label"><span className="idx">(02)</span><br />The Master’s Class · 2-day workshop</div>
      ...
      <section className="section">
        <div className="container">
          <div className="grid two" style={{ alignItems: 'start' }}>
            <Reveal>
              <div className="label"><span className="idx">(03)</span> &nbsp;Inspirational speaking</div>
