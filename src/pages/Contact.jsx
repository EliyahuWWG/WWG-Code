      ...
      <section className="section" style={{ paddingTop: 'clamp(40px,5vw,64px)' }}>
        <div className="container">
          <div className="grid two" style={{ alignItems: 'start' }}>
            <Reveal>
              <div className="label"><span className="sec-num">01</span><br />Send a message</div>
              <div className="mt-3"><ContactForm /></div>
            </Reveal>

            <Reveal delay={0.05}>
              <div className="label"><span className="sec-num">02</span><br />Other ways to reach him</div>
