...
export default function CTA({
  label = 'Start the conversation', title = 'Start the journey.', text = 'Bring the real decision that you face: strategy review, a potential new hire, budget change, the timing of a risk. A focused call to see how the Working With God method applies to it.',
